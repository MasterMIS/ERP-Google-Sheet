...
import { getGoogleSheetsClient, getNBDs } from '@/lib/sheets';
    ...
    try {
        ...
        if (!final_next_follow_up_date || !final_follow_up_date) {
            try {
                ...
                console.error('Error fetching NBD for fallback dates:', err);
            }
        }
